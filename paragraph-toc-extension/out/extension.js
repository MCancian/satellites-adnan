...
function generateTOCCore(editor, document) {
...
function loadAbbreviations(sourceUri) {
...
function extractSentences(text, abbreviations) {
...
function extractAllSentences(text, abbreviations) {
    const sentences = [];
...
function extractFirstSentence(text, abbreviations) {
...
function findParagraphStartLine(lines, paragraph, startIndex) {
...
function generateTOCContent(sections, document) {
...
function saveTOCFile(sourceUri, tocContent) {
    ...
    try {
        ...
        vscode.window.showInformationMessage(`TOC generated: ${tocFileName}`, 'Open TOC').then(selection => {
